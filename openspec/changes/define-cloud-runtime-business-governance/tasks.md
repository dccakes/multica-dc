...
- [ ] 1.2 Define checkpoint payload contract with required persisted fields for portable resume
...
- [ ] 4.1 Implement checkpoint writes on every state transition and 5-minute in-progress heartbeat
